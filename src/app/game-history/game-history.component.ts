...
import { GameResult } from '../score/game-result';
...
export class GameHistoryComponent {
  ...
  constructor(public players: PlayerService, public game: GameService) {}

  get reversedScoreTable() {
    return [...this.game.scoreTable].reverse();
  }

  resultToString(result: GameResult): string {
